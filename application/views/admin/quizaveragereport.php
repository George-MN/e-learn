...
<head>
    ...
    <title>Health E-learning | Reports</title>

    <link href="<?php echo base_url(); ?>tempcss/css/bootstrap.min.css" rel="stylesheet">
    <link href="font-awesome/css/font-awesome.css" rel="stylesheet">

    <!-- orris -->
    <link href="<?php echo base_url(); ?>tempcss/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
...
?>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>admin/quizperformance">Quiz performance</a></li>
 ...
 -->
            ...
            <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Quiz Performance in average % </h5>
   ...
   Morris.Bar({
        ...
        data: [
                { course: 'Anatomy', value: 50 },
                { course: 'Pharmacy', value: 10 },
                { course: 'Health Informatics', value: 25 },
                { course: 'Physiology', value: 0}
