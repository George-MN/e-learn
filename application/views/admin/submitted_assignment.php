...
<div class="ibox-title">
    <h5>These are the assignments that were submitted</h5>
...
<tbody>
<?php if($allassignment){ ?>
 <?php foreach ($allassignment as $r): {
     # code...
 }?>
<tr class="gradeX">
 ...
 <td><?php if ($r['status']!=1){
  ...
  ?></td>
 <td>
    <form name="myform" id="myform" action="<?php echo base_url() ?>content/view_individual_assignment" method="post">
     <input type="hidden" name="id" id="id" value="<?php echo $r['assignmentsubid'] ?>" />
