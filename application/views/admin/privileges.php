    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <h5><bold>Users Privileges</bold> </h5>
     ...
     # code...
                                            ...
                                            <tr>
                                             ...
                                             <td><?php 
                                             if($r['usertype']==1){
                                                echo '<button type="button" class="btn btn-w-m btn-primary">Learner</button>';
                                             }
                                             else if($r['usertype']==2){
                                                echo '<button type="button" class="btn btn-w-m btn-info">Content Writer</button>';
                                             }
                                             else{
                                                 echo '<button type="button" class="btn btn-w-m btn-warning">Admin</button>';
                                             }
                            ...
                            <a  class="btn btn-info btn-xs" href="<?php echo base_url() ?>admin/useredit?id=<?php echo $r['user_id']; ?>"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="<?php echo base_url() ?>admin/userdelete?id=<?php echo $r['user_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> gmaish tech.co &copy; 2014-2015
            </div>
        </div>
        ...
        $(document).on('change', '#courses', function(e)
            {
                ...
                serverRqst.done(function(responseStr)
                {
