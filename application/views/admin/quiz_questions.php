                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5><?php echo "Question ".$questionnum." "; ?><small>Create the quiz questions below</small></h5>
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="<?php echo base_url() ?>content/quiz_question">
                                <div class="form-group"><label class="col-sm-2 control-label">Question</label>

                                    <div class="col-sm-10"><textarea class="form-control" name="question" required="required"> </textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Choice 1</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="choice1" id="choice1" required="required" onblur="myFunctionchoice1()"> 
                                    </div> 
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Choice 2</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" id="choice2" name="choice2" required="required" onblur="myFunctionchoice2()"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Choice 3</label>

                                    <div class="col-sm-10"><input type="text" placeholder="" id="choice3" name="choice3" class="form-control" required="required" onblur="myFunctionchoice3()"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-lg-2 control-label">Choice 4</label>

                                    <div class="col-lg-10"><input type="text" name="choice4" id="choice4" required="required" placeholder="" class="form-control" onblur="myFunctionchoice4()"></div>
                                </div> 
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-lg-2 control-label">Answer</label>

                                    <div class="col-lg-10"><select class="form-control" id="answer" name="answer" required="required">
                                    <option> </option> 

                                    </select>
                                    </div>
                                </div>
                                <input type="hidden" placeholder="" id="choice3" name="quizid" value="<?php echo $quizid; ?>" class="form-control">
                                <input type="hidden" placeholder="" id="choice3" name="questionnum" value="<?php echo $questionnum; ?>" class="form-control">
                                <div class="hr-line-dashed"></div>
                                <div class="col-sm-10"><input type="submit" class="btn btn-primary" value="Next question"></div>
                                <div class="hr-line-dashed"></div>
...
<!-- 
    ...
    <script>
            ...
            $('#answer').append("<option >"+choice1+"</option>");
        }
        function myFunctionchoice2(){
            ...
            // var choice3=('#choice3').val();
            // var choice4=('#choice4').val();
            $('#answer').append("<option >"+choice2+"</option>");
        }
       function myFunctionchoice3(){
             
            var choice3= $('#choice3').val();
             //alert(choice1)3
            // var choice2=('#choice').val();
            // var choice3=('#choice3').val();
            // var choice4=('#choice4').val();
            $('#answer').append("<option >"+choice3+"</option>");
        }
       function myFunctionchoice4(){
            ...
            // var choice3=('#choice3').val();
            // var choice4=('#choice4').val();
            $('#answer').append("<option >"+choice4+"</option>");
        }
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('E-learning platform', 'Welcome to Health');
