...
<head>
    ...
    <link href="<?php echo base_url(); ?>tempcss/css/plugins/iCheck/custom.css" rel="stylesheet">
    <!-- Gritter -->
...
?>
              ...
              <ul class="nav" id="side-menu">
                  ...
                  <li class="active">
                      ...
                      <ul class="nav nav-second-level">
                          ...
                          <li class="active"><a href="<?php echo base_url(); ?>quiz/myquiz">Quiz</a></li>
    ...
    -->
        ...
        <div class="wrapper wrapper-content animated fadeIn">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form name="myform" id="myform" action="<?php echo base_url() ?>quiz/nextquestion" method="post">
                           ...
                           <h3> <?php echo $key['question']?></h3>
                            ...
                            <div class="radio i-checks"><label> <input type="radio" value="<?php echo $key['answer1'];?>" name="a" required="required"> <i></i> <?php echo $key['answer1']?> </label></div>
                               
                            </div>
                            <div class="alert alert-danger">
                               <div class="radio i-checks"><label> <input type="radio" value="<?php echo $key['answer2'];?>" name="a" required="required"> <i></i> <?php echo $key['answer2']?> </label></div>  
                            </div>
                            <div class="alert alert-danger">
                               <div class="radio i-checks"><label> <input type="radio" value="<?php echo $key['answer3']?>" name="a" required="required"> <i></i> <?php echo $key['answer3']?> </label></div> 
                            </div>
                            <div class="alert alert-danger">
                              <div class="radio i-checks"><label> <input type="radio" value="<?php echo $key['answer4']?>" name="a" required="required"> <i></i> <?php echo $key['answer4']?> </label></div>
                            </div>
                            <input type=text id="mycode" name="quizid" class="hidden" value="<?php echo $key['quiz_id'];?>">
                             <input type=text id="assid" name="questionnumber" class="hidden" value="<?php echo $key['question_number'];?>" >
      ...
      <?php       
                         ...
                         ?>
                        <h2>Youve successfully completed the quiz</h2>
     <form name="myform" id="myform" action="<?php echo base_url(); ?>quiz/viewresult" method="post">
     <input type="hidden" name="id" id="id" value="<?php echo $myquizid; ?>" />
     <input type="submit" class="btn btn-primary " value="viewresult" />
     </form>
                       <?php } ?> 
        <div class="footer">
    ...
    <script src="<?php echo base_url(); ?>tempcss/js/plugins/toastr/toastr.min.js"></script>
     <script src="<?php echo base_url(); ?>tempcss/js/plugins/iCheck/icheck.min.js"></script>
        <script>
