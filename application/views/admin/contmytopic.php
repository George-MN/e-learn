                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <h5><bold>My courses/ </bold>Topics </h5>
     ...
     # code...
                                            ...
                                            <tr>
                                             ...
                                             <a href="<?php echo base_url() ?>content/topicaddaudio/<?php echo $r['topicid'];?>"><button class="btn btn-primary btn-circle" type="button"><i class="fa fa fa-bullhorn"></i></button></a>
                                                ...
                                                <form name="myform" id="myform" action="<?php echo base_url() ?>content/topicdelete" method="post">
                                                 <input type="hidden" name="tid" id="id" value="<?php echo $r['topicid'] ?>" />
            ...
            <div class="ibox-content">
                            ...
                            <a data-toggle="modal" class="btn btn-primary" href="#modal-form">Add a Topic</a>
                            </div>
                            <div id="modal-form" class="modal fade" aria-hidden="true">
                                <div class="modal-dialog">
                                 ...
                                 <div class="row">
                                  <?php echo form_open('content/addtopic'); ?>
                                 <div class="form-group"><label class="col-sm-2 control-label">Courses</label>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">TopicNumber</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Topicname</label>
                                    <div class="col-sm-10">
        ...
        $(document).on('change', '#courses', function(e)
            {
                ...
                var URL =  <?php echo "'".base_url()."content/getCourseByCode'"; ?> ;
                var serverRqst = $.ajax({
                    url:URL,
                ...
                serverRqst.done(function(responseStr)
                {
                    ...
                    $('#durationj').val(responseObj[0]['duration']);
                    $('#categoryh').val(responseObj[0]['coursetype']);
