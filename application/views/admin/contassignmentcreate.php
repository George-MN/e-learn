    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
     ...
     # code...
                                            ...
                                            <tr>
                                             ...
                                             <td>
                                             <form name="myform" id="myform" action="<?php echo base_url() ?>content/assignment" method="post">
                                                 <input type="hidden" name="code" id="id" value="<?php echo $r['topicid']; ?>" />
