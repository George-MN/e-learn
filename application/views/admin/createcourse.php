                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>admin/createcourse">Create course</a></li>
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        ?>
                            <form method="post" class="form-horizontal" action="<?php echo base_url() ?>admin/insertcourse">
                                 
                                
                                
                                <div class="form-group"><label class="col-sm-2 control-label" >Course name</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="choice1" id="choice1" required="required" > 
                                    </div> 
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">course code</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" placeholder="" id="choice3" name="choice3" class="form-control" required="required" ></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-lg-2 control-label">Course description</label>

                                    <div class="col-lg-10"><input type="text" name="choice4" id="choice4" required="required" placeholder="" class="form-control" ></div>
                                </div> 
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="hr-line-dashed"></div>
                                <div class="col-sm-10"><input type="submit" class="btn btn-primary" value="create"></div>
                                <div class="hr-line-dashed"></div>
