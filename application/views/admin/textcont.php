                ...
                <div class="col-lg-4">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                         <div align="center"><img width="80" height="80" src="<?php echo base_url() ?>assets/img/note.png" ></div>
                            <div class="">
                            
                                <div class=""><?php echo $row['description']; ?></div></br>
                                
                            </div>
                            <form name="myform" id="myform" action="<?php echo base_url() ?>content/texttopic" method="post">
                                                 <input type="hidden" name="id" id="course" value="<?php echo $row['coursecode'] ?>" />
