                    ...
                    <li >
                     ...
                     <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>content/quiz_taken">Quizes</a></li>
...
<div class="ibox-title">
    <h5>These are the quizes youve set</h5>
...
<tr class="gradeX">
 ...
 <td><?php  echo $r['num_questions'] * 5; ?> </td>
 <td>
    <form name="myform" id="myform" action="<?php echo base_url() ?>content/view_quizdone_report" method="post">
     <input type="hidden" name="id" id="id" value="<?php echo $r['quizid'] ?>" />
     <input type="submit" class="btn btn-primary " value="View The report" />
     </form>
 </td>
