                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="<?php echo base_url(); ?>content/enrollment">Enrollment</a></li>
    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <h5><bold>Enrolled to my courses/ </bold>Click on the view button to view enrolled users </h5>
     ...
     # code...
                                            ...
                                            <tr>
                                             ...
                                             <td>
                                             <form name="myform" id="myform" action="<?php echo base_url() ?>content/users_doing" method="post">
                                                 <input type="hidden" name="code" id="id" value="<?php echo $r['coursecode'] ?>" />
                                                 <input type="submit" class="btn btn-primary " value="View users" />
                                                 </form></td>
