   ...
   <nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <div class="col-lg-12">
                    ...
                    <div id='response'>
                        ...
                        <div class="ibox-title">
                             <input type=text id="mycode" name="assignmentid" class="hidden" value="<?php echo $code; ?>">
    ...
    <script>
        ...
        var save = function() {
            ...
            if(id){
                var URL =  <?php echo "'".base_url()."courses/uploadsubassignment'"; ?> ;
              var serverRqst = $.ajax({
                    url:URL,
                    data:{aHTML:aHTML,
                          id:id,
                ...
                serverRqst.done(function(responseStr)
                {
                     ...
                     $('#assid').val(responseObj[0]['assignmentsubid']);
