                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <div class="row">
                            <form name="myform" id="myform" action="<?php echo base_url() ?>courses/assignmentsubmit" method="post">
     <input type="hidden" name="id" id="id" value="<?php echo $row['assignmentid']; ?>" />
     <input type="submit" class="btn btn-primary " value="Do assignment" />
     </form>
                                <div class="col-md-6">
