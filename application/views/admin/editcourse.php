            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url(); ?>admin/enrollment">Course enrollment</a></li>
                            <li><a href="<?php echo base_url(); ?>admin/quizperformance">Quiz performance</a></li>
                             <li><a href="<?php echo base_url(); ?>admin/userconratio">User-Content writers ratio</a></li>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="<?php echo base_url() ?>content/quiz_question">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label" value="<?php echo $r['coursename'];?>">Course name</label>
                                ...
                                <input type="hidden" placeholder="" id="choice3" name="quizid"  class="form-control">
