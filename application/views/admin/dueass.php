...
<div class="ibox-title">
    <h5>These are the Assignments given <a class="btn btn-primary" href="<?php echo base_url() ?>courses/assignsubmentdetails"> 
        View submitted assignments</a>
     </h5>
...
<tr class="gradeX">
 ...
 <td>
    <form name="myform" id="myform"  method="post" action="<?php echo base_url() ?>courses/assignmentdetails">
