                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li >
                     ...
                     <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="<?php echo base_url(); ?>admin/create_user">Allocate course</a></li>
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        ?>
                            <form method="post" class="form-horizontal" action="<?php echo base_url() ?>admin/insertcontup">
                                 
                                
                                
                               
                                <div class="form-group"><label class="col-lg-2 control-label">Un Allocated course</label>

                                    <div class="col-lg-10"><select class="form-control" id="answer" name="courseid" required="required">
                                    <option> </option>
                                    <?php 
                                     if($uncourses){
                                        foreach ($uncourses as $key) {
                                            # code...
                                    
                                    ?>
                                    <option value="<?php echo $key['coursecode'];?>"><?php echo $key['coursename'];?></option>
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group"><label class="col-lg-2 control-label">Content writers</label>

                                    <div class="col-lg-10"><select class="form-control" id="answer" name="userid" required="required">
                                    <option> </option>
                                   <?php 
                                     if($contwriter){
                                        foreach ($contwriter as $key) {
                                            # code...
