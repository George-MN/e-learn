                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>content/video">Video</a></li>
                ...
                <div class="col-lg-4">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                         <div align="center"><img width="80" height="80" src="<?php echo base_url() ?>assets/img/video.png" ></div>
                            <div class="">
                            
                                <div class=""><?php echo $row['topicdesc']; ?></div></br>
                                
                            </div>
                            <form name="myform" id="myform" action="<?php echo base_url() ?>content/studyvideo" method="post">
                                                 <input type="hidden" name="id" id="topicid" value="<?php echo $row['topicid'] ?>" />
