                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5> <small>Create the quiz questions below</small></h5>
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="<?php echo base_url() ?>content/quiz_details" >
                                
                                
                                <div class="form-group"><label class="col-sm-2 control-label">Quiz Name</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="quiz_name" required="required"> 
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Number of questions</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="num_questions" required="required"></div>
                                </div>
                                
                                <div class="hr-line-dashed"></div>
                                <input type="text"  name="topicid"  hidden="hidden" value="<?php echo $topicid; ?>">
                                 <input type="submit" class="btn btn-primary " value="Set questions" />
