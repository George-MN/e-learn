                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active" ><a href="<?php echo base_url(); ?>content/mypdf">PDF</a></li>
...
<tbody>
<?php if($pdfs){ ?>
 <?php foreach ($pdfs as $r): {
     # code...
 ?>
<tr class="gradeX">
 <td><img width="30" height="30" src="<?php echo base_url() ?>assets/img/pdf.png" ></td>
 <td><?php echo $r['size']/1000; 
 echo " Mbs";
 ?></td>
 <td><?php echo $r['name']; ?></td>
 <td>
 <a href="<?php echo base_url() ?>resource/<?php echo $r['pdfpath'] ?>" ><button type="button" class="btn btn-w-m btn-primary">Good</button></a>
