...
<tr class="gradeX">
 ...
 <td>
    <form name="myform" id="myform" action="<?php echo base_url() ?>quiz/doquiz" method="post">
     <input type="hidden" name="id" id="id" value="<?php echo $r['quizid'] ?>" />
     <input type="submit" class="btn btn-primary " value="Do The quiz" />
     </form>
 </td>
