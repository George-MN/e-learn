                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?php echo base_url(); ?>content/view_quiz">SView available quizes</a></li>
                    ...
                    <div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <div class="ibox-content m-b-sm border-bottom">
                            <div class="text-center p-lg">
                                ...
                                <button title="Create new cluster" class="btn btn-primary btn-sm" data-toggle="modal" href="#modal-form"><i class="fa fa-plus"></i> <span class="bold">Add question</span></button> 
                                ...
                                <div class="modal-dialog">
                                 ...
                                 <div class="row">
                                  <?php echo form_open('content/faqsadd'); ?>
                                 <div class="form-group"><label class="col-sm-2 control-label">Question</label>

                                
                               <div class="col-sm-10">
                                        <textarea  name="faq" class="form-control"
                                        id="category"
                                        ></textarea></br></br>
                                    </div>
                                </div>  </br></br>
                       ...
                       <div class="faq-item">
                            <div class="row">
                                <div class="col-md-7">
                                    <a data-toggle="collapse" href="<?php echo '#faq1'.$count;?>" class="faq-question"><?php echo $key['faq'];?></a>
                                    <small>Added by <strong><?php echo $key['author'];?></strong> <i class="fa fa-clock-o"></i> <?php echo $key['adddate'];?></small>
                                </div>
                               
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div id="<?php echo 'faq1'.$count;?>" class="panel-collapse collapse ">
