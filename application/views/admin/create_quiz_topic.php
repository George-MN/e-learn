    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <h5><bold>My courses/ </bold>Choose the course to create the quiz </h5>
     ...
     # code...
                                            ...
                                            <tr>
                                             ...
                                             <td><?php echo $r['topicnumber']; ?></td>
                                             
                                             <td>
                                             <form name="myform" id="myform" action="<?php echo base_url() ?>content/create_questions" method="post">
