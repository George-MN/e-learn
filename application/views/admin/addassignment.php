...
<head>
    ...
    <link href="<?php echo base_url(); ?>tempcss/css/plugins/summernote/summernote.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>tempcss/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">
...
?>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="<?php echo base_url(); ?>content/create_assignment">Create</a></li>
 ...
 -->
                ...
                <div class="col-lg-12">
                    ...
                    <div id='response'>
                        ...
                        <div class="ibox-title">
                             <input type=text id="mycode" name="mytopicid" class="hidden" value="<?php echo $code; ?>">
                             <input type=text id="assid" name="assis" class="hidden">
                        ...
                        <div class="ibox-content no-padding">
                            ...
                            <div class="click2edit wrapper p-md">
                                <h3>Pliz click edit to start typing</h3>
    ...
    <!-- SUMMERNOTE -->
    <script src="<?php echo base_url(); ?>tempcss/js/plugins/summernote/summernote.min.js"></script>
    ...
    <script>
        ...
        var save = function() {
            ...
            alert(assid);
            if(dur){
                var URL =  <?php echo "'".base_url()."content/uploadassignment'"; ?> ;
              var serverRqst = $.ajax({
                    url:URL,
                    data:{aHTML:aHTML,
                          id:id,
                ...
                serverRqst.done(function(responseStr)
                {
                     ...
                     $('#assid').val(responseObj[0]['assignmentid']);
                     //alert(responseObj[0]['assignmentid'])
                ...
                $('#response').val('Please put the due date');
                alert("Please put the due date");
            }
