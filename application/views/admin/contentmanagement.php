...
<div class="row border-bottom">
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <h5><bold>My courses/ </bold>Click on the Study button to start the study </h5>
     ...
     # code...
                            ...
                            <a  class="btn btn-info btn-xs" href="<?php echo base_url() ?>admin/courseedit?id=<?php echo $r['coursecode']; ?>"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="<?php echo base_url() ?>admin/coursedelete?id=<?php echo $r['coursecode']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
