                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>content/View_assignment">Submitted</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?php echo base_url(); ?>content/view_quiz">view all quiz</a></li>
...
<div class="ibox-title">
    <h5>These are the Assignments given</h5>
...
<tr class="gradeX">
 ...
 <td><?php echo $r['Assignmentname']; ?></td>
 <td><?php echo $r['duedate']; ?></td>
 <td><?php if ($r['status_ass']==1){
  echo '<button type="button" class="btn btn-w-m btn-danger">';
  echo 'Marked</button>';

}
  else{
    echo '<button type="button" class="btn btn-w-m btn-primary">Unmarked</button>';
   
  }
  ?></td>
 <td>
    <form name="myform" id="myform" action="<?php echo base_url() ?>content/allassignment" method="post">
     <input type="hidden" name="id" id="id" value="<?php echo $r['assignmentid'] ?>" />
     <input type="submit" class="btn btn-primary " value="View assignment" />
     </form>
 </td>
