            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content text-center">
                        <h4>The <?php echo $quizname; ?> Quiz is ready</h4>
                       
                        <br>
                        
                        <div class="tooltip-demo">
                        <form name="myform" id="myform" action="<?php echo base_url() ?>content/view_quizdone" method="post">
                         <input type="hidden" name="id" id="id" value="<?php echo $quizid; ?>" />
                         <input type="submit" class="btn btn-primary " value="View Quiz" />
                         </form>
                            ...
                            <a href="<?php echo base_url(); ?>content/mycourses"><button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                Back Home
                            </button></a>
                        </div>
                    </div>
